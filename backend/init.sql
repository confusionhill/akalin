...
-- 2. Users table (Decoupled from specific tenant)
CREATE TABLE users (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
...
-- 2b. Tenant Users Junction table (M:N relationship with access_role)
...
-- 2c. Tenant Join Invitations table (Tokens generated by admin with configurable expiry)
CREATE TABLE tenant_invitations (
    id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
    tenant_id UUID REFERENCES tenants(id) ON DELETE CASCADE,
    email VARCHAR(255) NOT NULL,
    access_role INTEGER NOT NULL DEFAULT 0,
...
INSERT INTO users (id, email, handle, full_name, password_hash) 
VALUES ('00000000-0000-0000-0000-000000000002', 'admin@example.com', 'confusion_hill', 'Admin User', '$2a$10$8s5qM8299K58x5uX.4lR1O0e6n.X/Yy.Xz.Xz.Xz.Xz.Xz.Xz.Xz');

-- Link default user to tenant via tenant_users as admin (role 60)
INSERT INTO tenant_users (tenant_id, user_id, access_role)
